...
#update connection name for Bookworm or Trixie
get_system_wifi_conn() {
    nmcli connection show | grep -E 'preconfigured|netplan' | awk '{print $1}'
}
SYSTEM_WIFI_CONN=$(get_system_wifi_conn)
